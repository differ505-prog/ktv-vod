 ...
 *   例：輸入繁中「陳奕迅」可同時命中簡中「陈奕迅」相關歌曲(及反向)
 */

// 繁簡單字對照字典（高頻 + 歌名/歌手常用字,音樂場景常用）
// 每對 [繁體, 簡體] 是單字 1-to-1 對應。寫死一份,新歌自動適用,不必重建。
const ZH_PAIRS = [
  // 高頻 1000 字中的常見差異字 + 音樂/歌手常用字
  ['愛','爱'],['國','国'],['語','语'],['體','体'],['業','业'],['風','风'],['動','动'],
  ['車','车'],['頭','头'],['麵','面'],['龍','龙'],['馬','马'],['鳥','鸟'],['龜','龟'],
  ['時','时'],['間','间'],['對','对'],['像','像'],['辦','办'],['廳','厅'],['廣','广'],
  ['場','场'],['專','专'],['欄','栏'],['蘭','兰'],['花','花'],['萬','万'],['億','亿'],
  ['畫','画'],['家','家'],['藝','艺'],['術','术'],['團','团'],['結','结'],['數','数'],
  ['據','据'],['旅','旅'],['遊','游'],['飯','饭'],['店','店'],['餐','餐'],['廳','厅'],
  ['貨','货'],['運','运'],['會','会'],['話','话'],['郵','邮'],['件','件'],['願','愿'],
  ['望','望'],['髮','发'],['網','网'],['絡','络'],['雲','云'],['計','计'],['算','算'],
  ['應','应'],['用','用'],['程','程'],['序','序'],['陳','陈'],['奕','奕'],['迅','迅'],
  ['張','张'],['學','学'],['友','友'],['劉','刘'],['德','德'],['華','华'],['周','周'],
  ['杰','杰'],['倫','伦'],['王','王'],['力','力'],['宏','宏'],['林','林'],['俊','俊'],
  ['蔡','蔡'],['依','依'],['林','林'],['田','田'],['馮','冯'],['甄','甄'],
  ['妮','妮'],['蘇','苏'],['芮','芮'],['齊','齐'],['秦','秦'],['林','林'],['毛','毛'],
  ['不','不'],['易','易'],['方','方'],['大','大'],['小','小'],['唱','唱'],['歌','歌'],
  ['聲','声'],['聽','听'],['曲','曲'],['調','调'],['樂','乐'],['鋼','钢'],['琴','琴'],
  ['吉','吉'],['他','他'],['貝','贝'],['斯','斯'],['夢','梦'],['回','回'],['憶','忆'],
  ['記','记'],['從','从'],['前','前'],['現','现'],['在','在'],['過','过'],['去','去'],
  ['來','来'],['到','到'],['見','见'],['聽','听'],['說','说'],['話','话'],['請','请'],
  ['讓','让'],['給','给'],['為','为'],['什','什'],['麼','么'],['這','这'],['那','那'],
  ['裡','里'],['邊','边'],['樣','样'],['點','点'],['兒','儿'],['氣','气'],['當','当'],
  ['時','时'],['候','候'],['叫','叫'],['再','再'],['次','次'],['還','还'],['會','会'],
  ['能','能'],['別','别'],['讓','让'],['像','像'],['以','以'],['為','为'],['所','所'],
  ['們','们'],['您','您'],['妳','你'],['他','他'],['她','她'],['誰','谁'],['嗎','吗'],
  ['呢','呢'],['吧','吧'],['啊','啊'],['哦','哦'],['嘿','嘿'],['喂','喂'],['嗯','嗯'],
  ['歐','欧'],['陽','阳'],['陽','阳'],['飛','飞'],['輪','轮'],['鳳','凤'],['凰','凰'],
  ['鴻','鸿'],['雁','雁'],['燕','燕'],['瑩','莹'],['晶','晶'],['瑋','玮'],['瑜','瑜'],
  ['勵','励'],['志','志'],['豪','豪'],['強','强'],['偉','伟'],['彥','彦'],['凱','凯'],
  ['倫','伦'],['佑','佑'],['嘉','嘉'],['欣','欣'],['怡','怡'],['慧','慧'],['貞','贞'],
  ['靈','灵'],['氣','气'],['質','质'],['量','量'],['變','变'],['顏','颜'],['色','色'],
  ['畫','画'],['話','话'],['表','表'],['達','达'],['親','亲'],['愛','爱'],['情','情'],
  ['感','感'],['覺','觉'],['應','应'],['該','该'],['當','当'],['選','选'],['擇','择'],
  ['題','题'],['難','难'],['簡','简'],['單','单'],['複','复'],['雜','杂'],['舊','旧'],
  ['新','新'],['整','整'],['齊','齐'],['亂','乱'],['錯','错'],['對','对'],['了','了'],
  ['發','发'],['長','长'],['短','短'],['高','高'],['低','低'],['遠','远'],['近','近'],
  ['深','深'],['淺','浅'],['輕','轻'],['重','重'],['快','快'],['慢','慢'],['早','早'],
  ['晚','晚'],['熱','热'],['冷','冷'],['暖','暖'],['涼','凉'],['藍','蓝'],['紅','红'],
  ['綠','绿'],['黃','黄'],['白','白'],['黑','黑'],['紫','紫'],['粉','粉'],['灰','灰'],
  ['銀','银'],['金','金'],['銅','铜'],['鐵','铁'],['鋼','钢'],['石','石'],['木','木'],
  ['花','花'],['草','草'],['樹','树'],['葉','叶'],['根','根'],['莖','茎'],['果','果'],
  ['實','实'],['種','种'],['土','土'],['水','水'],['火','火'],['山','山'],['海','海'],
  ['河','河'],['湖','湖'],['溪','溪'],['泉','泉'],['島','岛'],['岸','岸'],['邊','边'],
  ['橋','桥'],['路','路'],['街','街'],['巷','巷'],['樓','楼'],['屋','屋'],['門','门'],
  ['窗','窗'],['牆','墙'],['梯','梯'],['椅','椅'],['桌','桌'],['床','床'],['燈','灯'],
  ['鏡','镜'],['鐘','钟'],['錶','表'],['筆','笔'],['紙','纸'],['書','书'],['本','本'],
  ['頁','页'],['張','张'],['條','条'],['個','个'],['隻','只'],['條','条'],['片','片'],
  ['塊','块'],['顆','颗'],['粒','粒'],['滴','滴'],['杯','杯'],['瓶','瓶'],['袋','袋'],
  ['箱','箱'],['盒','盒'],['籃','篮'],['籠','笼'],['碗','碗'],['盤','盘'],['鍋','锅'],
  ['鏟','铲'],['刀','刀'],['叉','叉'],['匙','匙'],['筷','筷'],['盤','盘'],['碗','碗'],
  ['節','节'],['慶','庆'],['祝','祝'],['賀','贺'],['歡','欢'],['喜','喜'],['樂','乐'],
  ['悲','悲'],['傷','伤'],['痛','痛'],['哭','哭'],['笑','笑'],['淚','泪'],['汗','汗'],
  ['血','血'],['命','命'],['靈','灵'],['魂','魂'],['心','心'],['意','意'],['念','念'],
  ['願','愿'],['夢','梦'],['想','想'],['望','望'],['信','信'],['念','念'],['望','望'],
  ['風','风'],['雨','雨'],['雪','雪'],['霜','霜'],['露','露'],['雷','雷'],['電','电'],
  ['光','光'],['影','影'],['星','星'],['月','月'],['日','日'],['雲','云'],['天','天'],
  ['地','地'],['空','空'],['海','海'],['陸','陆'],['島','岛'],['岸','岸'],['邊','边'],
];

// 把對照表展開成 Map（執行一次,後續比對用 replaceAll 字元替換）
const T2S_MAP = new Map();
const S2T_MAP = new Map();
for (const [t, s] of ZH_PAIRS) {
  if (!T2S_MAP.has(t)) T2S_MAP.set(t, s);
  if (!S2T_MAP.has(s)) S2T_MAP.set(s, t);
}
...
function matchSong(song, q) {
  ...
  // 對 song 欄位:原值 + 繁→簡 + 簡→繁（雙向索引,任何輸入形式都涵蓋）
  // 對 query:原值 + 繁→簡 + 簡→繁
  const qVariants = [q, t2sConvert(q), s2tConvert(q)];
  return fields.some((f) => {
    const text = String(f || '').toLowerCase();
    const textT2S = t2sConvert(text);
    const textS2T = s2tConvert(text);
    return qVariants.some((qv) => {
      const qLower = qv.toLowerCase();
      if (!qLower) return false;
      return text.includes(qLower) || textT2S.includes(qLower) || textS2T.includes(qLower);
    });
  });
}
